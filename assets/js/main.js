...
var app = new Vue({
  ...
  methods: {
    newGame: function newGame() {
      if (this.username !== '') {
        this.codPartita = this.genCodPartita(); //post axios
    ...
    genCodPartita: function genCodPartita() {
      var result = [];
    ...
    joinGame: function joinGame() {
      //chiamata axios
      if (this.codPartita) {//controllo esiste
      } else {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcards_agains_boolean"] = self["webpackChunkcards_agains_boolean"] || [];
